...
class screen:
    def __init__(self, root):
        ...
        root.geometry("900x600+50+150")
        root.title("Front End by Akash Chauhan,20CS3006")
        self.frame = cpu_scheduler.Frame(self.root)
        cpu_scheduler.Label(self.root, text="OS SHEDULING TOOL BY NIRAJ SIR", font="consolas").grid(padx=330)
